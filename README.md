...
Before you can use this tool by running the Python script, you need to have Python installed on your computer.
...
Another pop-up window titled "Select Overtime Excel File" will then appear. Use this to navigate to and select your Overtime Excel File. Click "Open".
Wait for Processing:
